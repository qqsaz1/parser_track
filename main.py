...
def resample_coordinates(coords, step_meters=3.0):
    if not coords:
        return []
...
def process_track_file(input_filename, output_filename, step_meters=3.0):
    ...
    for feature in data.get("features", []):
        ...
        if geom.get("type") == "LineString":
            ...
            new_coords = resample_coordinates(original_coords, step_meters)
...
if __name__ == "__main__":
    ...
    process_track_file(INPUT_FILE, OUTPUT_FILE, step_meters=3.0)
